...
const paginationTheme: FlowbitePaginationTheme = {
  ...
  pages: {
    ...
    selector: {
      base: 'w-10 border-gray-300 bg-white py-2 px-2 leading-tight text-gray-500 enabled:hover:bg-gray-100 enabled:hover:text-gray-700 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 enabled:dark:hover:bg-gray-700 enabled:dark:hover:text-white',
      active: 'bg-yellow-400 opacity-50 rounded-full text-black hover:bg-cyan-100 hover:text-cyan-700 dark:border-gray-700 dark:bg-gray-700 dark:text-white',
