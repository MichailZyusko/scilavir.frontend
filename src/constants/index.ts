...
export const GROUPS_AND_CATEGORIES_MAPPER = new Map<string, Record<string, any>>([
  ...
  ['2a20ee10-9707-46e1-a67d-dd9638eee029', {
    className: 'div1',
    style: { gridArea: 'div1', height: 600, backgroundImage: "url('/images/for-art.jpg')" },
  }],
  // "Для офиса"
  ['ef81773b-1dce-42f3-9d27-e509190be4cb', {
    className: 'div2',
    style: { gridArea: 'div2', backgroundImage: "url('/images/for-office.jpg')" },
  }],
  // "Для школы"
  ['2a768604-c79f-4cc5-ad41-e56c99a5cb4f', {
    className: 'div3',
    style: { gridArea: 'div3', backgroundImage: "url('/images/for-school.jpg')" },
  }],
  // "Для печати"
  ['749241db-5453-400e-972d-fb3635e0d38d', {
    className: 'div4',
    style: { gridArea: 'div4', backgroundImage: "url('/images/for-printing.jpg')" },
  }],

  // "Бумага и бумажная продукция"
  ['cb506ce3-bd16-4032-87fe-c747973b1156', {
    className: 'div1',
    style: { gridArea: 'div1' },
  }],
  // "Органайзеры"
